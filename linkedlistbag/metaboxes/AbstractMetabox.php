...
abstract class AbstractMetabox {
	...
	public function print_nonce() {
		wp_nonce_field($this->get_nonce_key(), $this->get_nonce_key(), $this->get_nonce_path(), true);
	}

	public function verify_nonce() {
		return !isset($_POST[$this->get_nonce_key()]) || !wp_verify_nonce($_POST[$this->get_nonce_key()], $this->get_nonce_key());
	}
